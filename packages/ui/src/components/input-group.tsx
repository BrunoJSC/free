...
import { Textarea } from "@free/ui/components/textarea";
import { cn } from "@free/ui/lib/utils";
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useKeyWithClickEvents: clicking the addon is a pointer-only shortcut to focus the control; keyboard users tab straight to it
		// biome-ignore lint/a11y/noStaticElementInteractions: the addon is a decorative slot, so the focus shortcut must not make it a focusable control of its own
		// biome-ignore lint/a11y/noNoninteractiveElementInteractions: same reason — the slot stays non-interactive on purpose
		<div
