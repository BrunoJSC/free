...
// biome-ignore lint/performance/noBarrelFile: this is a component module that re-exports the primitive's hooks alongside its styled components, not a barrel file
export {
	useMessageScroller,
